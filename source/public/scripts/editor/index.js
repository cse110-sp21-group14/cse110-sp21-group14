 ...
 */
 class Events {
  ...
  makeListWrapper(style = this.listStyle, classes = []) {
    const tag = style === 'ul';
    const styleClass = this.CSS.wrapperEvents;
  ...
  get CSS() {
    return {
      ...
      wrapperEvents: 'cdx-nested-list--event',
  ...
  set listStyle(style) {
     ...
     */
    lists.forEach(list => {
      list.classList.toggle(this.CSS.wrapperEvents, style === 'unordered');
    });
 ...
 */
 class Notes {
   ...
   */
   makeListWrapper(style = this.listStyle, classes = []) {
    const tag = style === 'ul';
    const styleClass = this.CSS.wrapperNotes;
  ...
  get CSS() {
    return {
      baseBlock: this.api.styles.block,
      wrapper: 'cdx-nested-list',
      wrapperNotes: 'cdx-nested-list--notes',
      item: 'cdx-nested-list__item',
      itemBody: 'cdx-nested-list__item-body',
      itemContent: 'cdx-nested-list__item-content',
      itemChildren: 'cdx-nested-list__item-children',
  ...
  set listStyle(style) {
     ...
     */
    lists.forEach(list => {
      list.classList.toggle(this.CSS.wrapperNotes, style === 'unordered');
    });
 ...
 */
 class Tasks {
  ...
  makeListWrapper(style = this.listStyle, classes = []) {
    const tag = style === 'ul';
    const styleClass = this.CSS.wrapperTasks;
  ...
  get CSS() {
    return {
      baseBlock: this.api.styles.block,
      wrapper: 'cdx-nested-list',
      wrapperTasks: 'cdx-nested-list--task',
      item: 'cdx-nested-list__item',
      itemBody: 'cdx-nested-list__item-body',
      itemContent: 'cdx-nested-list__item-content',
      itemChildren: 'cdx-nested-list__item-children',
  ...
  set listStyle(style) {
     ...
     */
    lists.forEach(list => {
      list.classList.toggle(this.CSS.wrapperTasks, style === 'unordered');
    });
